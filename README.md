# Bem vindo, sou o Alex Leal! 👋

---
### 👨‍💻 Sobre Mim
- 🎓 **Formação Base:** Tive meu primeiro contato com programação no ensino médio técnico em informática, onde aprendi lógica de programação, bancos de dados e desenvolvimento web.
- 🏢 **Experiência Prática:** Atuei como menor aprendiz no **SERPRO** (trabalhando com PHP, ZendFramework, MySQL e Git), passei pelo suporte técnico no **TRE-PR** e em empresas de telecom, e atualmente atuo como **Técnico de Suporte JR na Positivo Tecnologia**.
- 🚀 **Objetivo:** Transição consolidada para **Desenvolvimento Back-end / Full-stack**, focando na construção de arquiteturas sólidas, código limpo e testes automatizados.
- 🌐 **Idiomas:** 
  - 🇺🇸 **Inglês:** Proficiente (EF SET C2)
  - 🇫🇷 **Francês:** Básico
